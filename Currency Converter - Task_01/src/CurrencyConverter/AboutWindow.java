...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		// Label "author"
		JLabel lblAuthor = new JLabel("Made by SAI PRITAM PANDA"); //$NON-NLS-1$
		lblAuthor.setHorizontalAlignment(SwingConstants.CENTER);
		lblAuthor.setBounds(65, 122, 219, 33);

		// label with a clickable link
		JLabel lblLink = new JLabel("https://www.linkedin.com/in/sai-pritam-panda-4bb115231/");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://www.linkedin.com/in/sai-pritam-panda-4bb115231/"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
